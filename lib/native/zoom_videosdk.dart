...
// SDK public API uses legacy identifiers that are part of the public surface.
...
class RawDataMemoryMode {
  ...
  static const String Stack = 'ZoomVideoSDKRawDataMemoryModeStack';
  static const String Heap = 'ZoomVideoSDKRawDataMemoryModeHeap';
}

class SubscribeFailReason {
  const SubscribeFailReason();
...
class AnnotationToolType {
  ...
  static const String AutoStampCheck = 'ZoomVideoSDKAnnotationToolType_AutoStampCheck';
...
class Errors {
  ...
  static const JoinSessionTokenMismatchedSessionName = 'ZoomVideoSDKError_JoinSession_Token_MismatchedSessionName';
  static const JoinSessionTokenNoSessionName = 'ZoomVideoSDKError_JoinSession_Token_NoSessionName';
  static const JoinSessionTokenRoleTypeEmptyOrWrong = 'ZoomVideoSDKError_JoinSession_Token_RoleType_EmptyOrWrong';
  static const JoinSessionTokenUserIdentityTooLong = 'ZoomVideoSDKError_JoinSession_Token_UserIdentity_TooLong';
  ...
  static const RawdataSendTooMuchDataInSingleTime = 'ZoomVideoSDKError_Rawdata_Send_Too_Much_Data_In_Single_Time';
...
class ZoomVideoSdk extends ZoomVideoSdkPlatform {
  ...
  Future<String> initSdk(InitConfig configs) async {
    ...
    return await methodChannel.invokeMethod<String>('initSdk', configMap).then<String>((String? value) => value ?? "");
  }
  ...
  @override
  Future<String> getSdkVersion() async {
    return await methodChannel.invokeMethod<String>('getSdkVersion').then<String>((String? value) => value ?? "");
  }
  ...
  @override
  Future<bool> acceptRecordingConsent() async {
    return await methodChannel.invokeMethod<bool>('acceptRecordingConsent').then<bool>((bool? value) => value ?? false);
  }
  ...
  @override
  Future<String> exportLog() async {
    return await methodChannel.invokeMethod<String>('exportLog').then<String>((String? value) => value ?? "");
  }
