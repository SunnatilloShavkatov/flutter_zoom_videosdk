...
class ZoomVideoSdkShareStatisticInfo extends ZoomVideoSdkShareStatisticInfoPlatform {
  ...
  Future<num> getBpf() async {
    ...
    return await methodChannel.invokeMethod<num>('getUserShareBpf', params).then<num>((num? value) => value ?? 0);
  }
  ...
  Future<num> getFps() async {
    ...
    return await methodChannel.invokeMethod<num>('getUserShareFps', params).then<num>((num? value) => value ?? 0);
  }
  ...
  Future<num> getHeight() async {
    ...
    return await methodChannel.invokeMethod<num>('getUserShareHeight', params).then<num>((num? value) => value ?? 0);
  }
  ...
  Future<num> getWidth() async {
    ...
    return await methodChannel.invokeMethod<num>('getUserShareWidth', params).then<num>((num? value) => value ?? 0);
  }
}
